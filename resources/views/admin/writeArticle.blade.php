...
<div class="container">
	<div class="row justify-content-center">
		...
		<div class="col-md-10">
			<form method="POST" action="{{ route('saveArticle', ['id' => $article->id]) }}" aria-label="{{ __('SaveArticle') }}">
            @csrf
					...
					<div class="card">
						...
						<div class="card-body mx-4">
							<div class="md-form">
								...
								<input type="text" name="summary" id="summary" class="form-control" value="{{$article->summary}}">
							</div>
						</div>	
