<div class="modal fade editTypeUserModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="editTypeUserModal">Editar Tipo Usuário</h4>
            ...
            <div class="modal-body">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <form id="editTypeUser" method="POST" action="" aria-label="{{ __('EditTypeUsers') }}">
                                    @method('PATCH')
                                    @csrf
