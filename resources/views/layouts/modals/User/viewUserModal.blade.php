<div class="modal fade viewUserModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="viewUserModal">Dados Usuário</h4>
                        ...
                        <div class="box box-widget widget-user">
                            ...
                            <div class="box-footer">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="description-block">
                                            <h5 class="description-header" id="desc_user"></h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="description-block">
                                            <h5 class="description-header" id="created_at"></h5>
                                            <span class="description-text">Inscrito desde</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
